...
String url = Statics.BASE_URL+"/portfolioJSON/new?intro="+ intro +"&about="+ about ;
        req.setUrl(url);
        req.setPost(false);
    ...
    String url = Statics.BASE_URL + "/portfolioJSON/"+p.getId_portfolio()+"/edit?intro="+ p.getIntro() +"&about="+ p.getAbout(); 
...
//       /portfolioJSON/222/edit?intro="hello%20to%20you"&about=thisistheabout
   ...
   public boolean deletePortfolio(int id) {
        String url = Statics.BASE_URL + "/portfolioJSON/"+id+"/delete";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Portfolio> getAllPortfolios() {
        String url = Statics.BASE_URL + "/portfolioJSON/";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    String url = Statics.BASE_URL + "/portfolioJSON/f/"+pId+"/";
    req.setUrl(url);
    req.setPost(false);
    req.addResponseListener(new ActionListener<NetworkEvent>() {
        @Override
