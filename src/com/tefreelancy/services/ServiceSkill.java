...
public class ServiceSkill {
    ...
    public boolean addSkill(Skill s){
        String url = GroupsUtils.BASE_URL+"/skillsJSON/new?name="+s.getName()+"&level="+s.getLevel().toString() ;
    ...
    String url = GroupsUtils.BASE_URL + "/skillsJSON/"+s.getId_skill()+"/edit?name="+s.getName()+"&level="+s.getLevel(); 
...
//       /portfolioJSON/222/edit?intro="hello%20to%20you"&about=thisistheabout
   ...
   public boolean deleteSkill(int id) {
        String url = GroupsUtils.BASE_URL + "/skillsJSON/delete/"+id;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Skill> getAllSkills(){
        String url = GroupsUtils.BASE_URL+"/skillsJSON/" ;
        req.setUrl(url); 
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>(){
            @Override
    ...
    String url = GroupsUtils.BASE_URL + "/skillsJSON/f/"+sId+"/";
    req.setUrl(url);
    req.setPost(false);
    req.addResponseListener(new ActionListener<NetworkEvent>() {
        @Override
