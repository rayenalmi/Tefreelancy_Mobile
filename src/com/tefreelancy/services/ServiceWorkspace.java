...
public Freelancer freelancer;
   ...
   public boolean addWorkspace(Workspace t,int idUsr) {
    String url = Statics.BASE_URL + "/workspace/addWsJSON/new/"+idUsr + "?name=" + t.getName()+ "&description=" + t.getDescription();
   ...
   public boolean deleteWorkspace(int id) {
        String url = Statics.BASE_URL + "/workspace/deleteWsJSON/" + id ;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
   ...
   public Freelancer parseFreelancer(String jsonText) {
    ...
    public ArrayList<Workspace> getAllWorkspaces(int userId) {
        String url = Statics.BASE_URL + "/workspace/AllWsForFreeJson/"+userId;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Freelancer> getAllFreelancers(int workspaceId) {
        String url = Statics.BASE_URL + "/workspace/AllFreeForWsJson/"+workspaceId;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
 ...
 public Workspace getWorkspaceById(int workspaceId) {
    String url = Statics.BASE_URL + "/workspace/getWsById/" + workspaceId;
    req.setUrl(url);
    req.setPost(false);
    req.addResponseListener(new ActionListener<NetworkEvent>() {
        @Override
  ...
  public Freelancer getFreelancerByEmail(String email) {
    String url = Statics.BASE_URL + "/workspace/getWsByEmail?email="+email;
    req.setUrl(url);
    req.setPost(false);
    req.addResponseListener(new ActionListener<NetworkEvent>() {
        @Override
  ...
  public Boolean addFreelancerByEmail(int workspaceId,String email) {
    String url = Statics.BASE_URL + "/workspace/addFreeToWs/" + workspaceId+"?email="+email;
    req.setUrl(url);
    req.setPost(false);
    req.addResponseListener(new ActionListener<NetworkEvent>() {
        @Override
