...
public class ServiceQuestion {
    ...
    public boolean addQuestion(Question q) {
        ...
        String url = Statics.BASE_URL + "/questionJSON/new?quest=" + q.getQuest()+ "&choice1=" + q.getChoice1()+ "&choice2=" + q.getChoice2()+ "&choice3=" + q.getChoice3()+ "&response=" + q.getResponse()+ "&idTest=" + q.getId_test();
...
//    }
    ...
    public ArrayList<Question> getAllQuestionsById(int id) {
        String url = Statics.BASE_URL + "/testJSON/passtest/" + id;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    {
        String url = Statics.BASE_URL+"/questionJSON/edit/"+t.getId_question()+"?quest="+t.getQuest()+"&choice1="+t.getChoice1()+"&choice2="+t.getChoice2()+"&choice3="+t.getChoice3()+"&response="+t.getResponse()+"&idTest="+t.getId_test();
        req.setUrl(url);
...
return resultOK;
    ...
    public boolean deleteQuestion(int id) {
        String url = Statics.BASE_URL + "/questionJSON/delete/" + id ;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
