...
public class ServiceTest {
    ...
    public boolean addTest(Test t) {
        ...
        String url = GroupsUtils.BASE_URL + "/testJSON/new?name=" + t.getName() + "&type=" + t.getType();
    ...
    public ArrayList<Test> getAllTests() {
        String url = GroupsUtils.BASE_URL + "/testJSON/";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    {
        String url = GroupsUtils.BASE_URL+"/testJSON/edit/"+t.getId_test()+"?name="+t.getName()+"&type="+t.getType();
        req.setUrl(url);
...
return resultOK;
    ...
    public boolean deleteTest(int id) {
        String url = GroupsUtils.BASE_URL + "/testJSON/delete/" + id ;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
