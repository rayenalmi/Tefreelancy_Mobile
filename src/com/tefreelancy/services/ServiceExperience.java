...
String url = Statics.BASE_URL+"/experienceJSON/new?title="+ title +"&description="+ desc +"&location=" + location +"&duration="+ duration +"&type="+type ;
        req.setUrl(url);
        req.setPost(false);
...
//       /portfolioJSON/222/edit?intro="hello%20to%20you"&about=thisistheabout
   ...
   public boolean deleteExp(int id) {
    ...
    public ArrayList<Experience> getAllExps() {
        String url = Statics.BASE_URL + "/experienceJSON/";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    String url = Statics.BASE_URL + "/experienceJSON/f/"+eId+"/";
    req.setUrl(url);
    req.setPost(false);
    req.addResponseListener(new ActionListener<NetworkEvent>() {
        @Override
