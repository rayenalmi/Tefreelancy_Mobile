...
public class ServicePostWs {
    ...
    String url = Statics.BASE_URL + "/publication/ws/addPostJSON/new/" + workspaceId + "?title=" + t.getTitle() + "&content=" + t.getContent()+"&author="+t.getAuthor();
    ...
    String url = Statics.BASE_URL + "/publication/ws/updatePostJSON/" + t.getId() + "/" + workspaceId + "?title=" + t.getTitle() + "&content=" + t.getContent()+"&author="+t.getAuthor();
    req.setUrl(url);
    ...
    public ArrayList<PublicationWs> parsePublicationWss(String jsonText){
       ...
       public boolean deletePost(int id, int workspaceId) {
        String url = Statics.BASE_URL + "/publication/ws/deletePostJSON/" + id + "/" + workspaceId;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<PublicationWs> getAllPublicationWss(int workspaceId) {
        String url = Statics.BASE_URL + "/publication/ws/AllPostsJson/"+workspaceId;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
